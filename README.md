...
4. In Settings > Server > Agents move The Movie Database to second to last and Local Media Assets (Movies) to last.<br />
5. In Settings > Server > Agents > The Movie Database > check "Include adult content"<br />
